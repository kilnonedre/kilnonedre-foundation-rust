...
pub static GRPC_CATALOG_PORT: Lazy<u16> = Lazy::new(|| load_env_u16("GRPC_CATALOG_PORT"));
...
pub static GRPC_TRADE_PORT: Lazy<u16> = Lazy::new(|| load_env_u16("GRPC_TRADE_PORT"));
...
pub static GRPC_LOGISTIC_PORT: Lazy<u16> = Lazy::new(|| load_env_u16("GRPC_LOGISTIC_PORT"));

pub static GRPC_WMS_PORT: Lazy<u16> = Lazy::new(|| load_env_u16("GRPC_WMS_PORT"));

pub static GRPC_PROCUREMENT_PORT: Lazy<u16> = Lazy::new(|| load_env_u16("GRPC_PROCUREMENT_PORT"));
